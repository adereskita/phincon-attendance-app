...
protocol ClientAPIProtocol {
    ...
    func putEditProfile(token: String, fullname: String, idcardnumber: String, address: String, completionHandler: @escaping (Result<EditProfileModel.Put.Response, APIError>) -> Void)
...
class ClientAPI: BaseAPI<RouterAPI>, ClientAPIProtocol {
    func putEditProfile(token: String, fullname: String, idcardnumber: String, address: String, completionHandler: @escaping (Result<EditProfileModel.Put.Response, APIError>) -> Void) {
        self.fetchData(target: .putEditProfile(token: token,  fullname: fullname, idcardnumber: idcardnumber, address: address), responseClass: EditProfileModel.Put.Response.self, completionHandler: { result in
